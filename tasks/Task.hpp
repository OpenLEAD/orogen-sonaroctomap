...
#ifndef SONAROCTOMAP_TASK_TASK_HPP
#define SONAROCTOMAP_TASK_TASK_HPP
...
namespace sonaroctomap {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','sonaroctomap::Task')
     end
     \endverbatim
    ...
    public:
         ...
         */
        Task(std::string const& name = "sonaroctomap::Task", TaskCore::TaskState initial_state = Stopped);
